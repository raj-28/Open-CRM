...
urlpatterns = [
    ...
    path('task/<slug:slug>',views.task_detail,name='details'),
    path('task-approve/<slug:slug>',views.task_approve,name='approval-detail'),
    path('merge-task-approve/<slug:slug>',views.merge_task_approve,name='merge-approval-detail'),
    path('download-assigned-task-report',views.download_assigned_task_report,name='download_assigned_task_report'),
    path('download-created-task-report',views.download_created_task_report,name='download_created_task_report'),
    path('download-completed-task-report',views.download_completed_task_report,name='download_completed_task_report'),
    path('download-merged-task-report',views.download_merged_task_report,name='download_merged_task_report'),
    ...
    path('merged-task/',views.merged_task,name='merged_task'),
